                    ...
                    <form method="POST" action="{{ route('admin.invoices.store') }}" class="space-y-5">
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input name="number" value="{{ old('number') }}" class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900" required placeholder="INV-2026-0001" />
                            ...
                            <div>
                                ...
                                <select name="type" class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900" required>
                                    @foreach (['retainer' => 'Retainer', 'project' => 'Project (50% advance)', 'success_fee' => 'Success Fee'] as $v => $l)
                                        <option value="{{ $v }}" @selected(old('type', 'retainer') === $v)>{{ $l }}</option>
                                    @endforeach
                                </select>
                                @error('type') <div class="mt-1 text-sm text-red-400">{{ $message }}</div> @enderror
                            </div>
                        </div>
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input name="amount" value="{{ old('amount') }}" type="number" step="0.01" min="0" class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900" required />
                                @error('amount') <div class="mt-1 text-sm text-red-400">{{ $message }}</div> @enderror
                            </div>
                            <div>
                        ...
                        <div class="grid gap-4 sm:grid-cols-3">
                            <div>
                                ...
                                <input type="date" name="issued_at" value="{{ old('issued_at') }}" class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900" />
                            </div>
                            <div>
                                <label class="text-sm font-medium">Due At</label>
                                <input type="date" name="due_at" value="{{ old('due_at') }}" class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900" />
                            </div>
                            <div>
                                <label class="text-sm font-medium">Paid At</label>
                                <input type="date" name="paid_at" value="{{ old('paid_at') }}" class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900" />
                            </div>
                        </div>
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input name="advance_required_percent" value="{{ old('advance_required_percent', 0) }}" type="number" min="0" max="100" class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900" />
                            </div>
                            <div>
                                <label class="text-sm font-medium">Advance Paid Amount (USD)</label>
                                <input name="advance_paid_amount" value="{{ old('advance_paid_amount', 0) }}" type="number" step="0.01" min="0" class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900" />
                            </div>
                        </div>
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input name="success_fee_percent" value="{{ old('success_fee_percent') }}" type="number" step="0.01" min="0" max="100" class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900" />
                            </div>
                            <div>
                                <label class="text-sm font-medium">Incremental Profit (USD)</label>
                                <input name="incremental_profit_amount" value="{{ old('incremental_profit_amount') }}" type="number" step="0.01" min="0" class="mt-2 w-full rounded-lg border-gray-300 dark:border-gray-700 dark:bg-gray-900" />
                            </div>
                        </div>
